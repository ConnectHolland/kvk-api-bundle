...
class ResultDataCompanyBasicV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ConnectHolland\\KvkApiBundle\\API\\Client\\Model\\ResultDataCompanyBasicV2';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \ConnectHolland\KvkApiBundle\API\Client\Model\ResultDataCompanyBasicV2;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \ConnectHolland\KvkApiBundle\API\Client\Model\ResultDataCompanyBasicV2();
        ...
        if (property_exists($data, 'items')) {
            ...
            foreach ($data->{'items'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'ConnectHolland\\KvkApiBundle\\API\\Client\\Model\\CompanyBasicV2', 'json', $context);
            }
